 ...
 *  Will create the chimp::s32, chimp::s64, chimp::u32 and chimp::u64 types.
 *  @author Aaron Moss
 */
...
int main(int argc, char** argv) {
	...
	out << "#ifndef _CHIMP_FIXED_WIDTH_HPP_\n"
	    << "#define _CHIMP_FIXED_WIDTH_HPP_\n" << endl;
	...
	out << "#endif /* _CHIMP_FIXED_WIDTH_HPP_ */" << endl;
